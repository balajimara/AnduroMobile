      ...
      <View className="flex-row mt-6 px-7">
        <View className='flex-1 flex-row justify-between'>
          <TouchableOpacity className="bg-clipboard rounded-3xl flex-row justify-center items-center h-12 px-2">
            <Image source={require('../../assets/images/Copy.png')} className="mr-1" />
            <Text className="font-['Geist-Regular'] text-sm text-phrasebutton">Copy to Clipboard</Text>
          </TouchableOpacity>
          <TouchableOpacity className="bg-clipboard rounded-3xl flex-row justify-center items-center h-12 px-4">
            <Image source={require('../../assets/images/CornersOut.png')} className="mr-1" />
            <Text className="font-['Geist-Regular'] text-sm text-phrasebutton">Download keys</Text>
          </TouchableOpacity>
        </View>
      </View>
      <TouchableOpacityVW
