     ...
     <View className="bg-gray h-full flex flex-col justify-between">
      <View>
       <View className="p-14 px-6 pb-0">
        <View className="mb-10"><Text className="text-center text-3xl text-lightgray opacity-95 leading-10 font-geistsemibold">Select Currency</Text></View>
       </View>
       <View>
        <ListItem className="bg-transparent" containerStyle={styles.listView}>
          ...
          <View className="border-b-2 border-currencyLine p-2 pr-0 mb-0">
           <View className="justify-between flex-row flex-wrap">
            <View className="flex-row items-center">
             ...
             <Text className="text-base font-geistregular text-walletLight custom-radio relative cursor-pointer">USD</Text>
            </View>
            <View>
             <CheckBox
         ...
         <View className="py-2 px-5 w-full">
          <View className="border-b-2 border-currencyLine p-2 pr-0 mb-0">
           <View className="justify-between flex-row flex-wrap">
            <View className="flex-row items-center">
             <View className="mr-2"><Image resizeMode={"contain"} source={require("../../../assets/images/euro-flag.png")} className="w-8 m-auto" /></View>
             <Text className="text-base font-geistregular text-walletLight custom-radio relative cursor-pointer">USD</Text>
            </View>
            <View>
             <CheckBox
