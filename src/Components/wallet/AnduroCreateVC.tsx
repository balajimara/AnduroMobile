        ...
        <SafeAreaView> 
         <View className="bg-gray h-full flex flex-col justify-between">
          <View className="p-14 px-6">
           <View className="text-center w-40 m-auto mb-4"><Text className="text-3xl text-lightgray opacity-95 leading-9 font-geistsemibold font-semibold">Let's name your wallet</Text></View>
           <View className="mb-10">
            <Text className="font-geistregular text-headingcolor text-sm text-center font-normal">Back it up, and do not share this with anyone.</Text>
           </View>
           <View>
          ...
          <View className="w-full p-5 px-6">
           <TouchableOpacity className="bg-continue w-full h-12 py-2.5 rounded-lg font-[jetbrains]">
            <Text className="text-white w-full text-center text-base">Continue</Text>
           </TouchableOpacity>
          </View>
         </View>
        </SafeAreaView>  
